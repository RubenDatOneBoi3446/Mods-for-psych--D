function onCreate()
	makeLuaSprite('phonebg', 'phonebg', -1700, -900);
	scaleObject('phonebg', 2, 2);
	addLuaSprite('phonebg', false)

	makeLuaSprite('phonesky', 'hi', -1700, -900);
	scaleObject('phonesky', 2, 2);
	addLuaSprite('phonesky', false)

	makeLuaSprite('poopsky', 'poop', -1700, -900);
	scaleObject('poopsky', 2, 2);
	setProperty('poopsky.visible', false)
	addLuaSprite('poopsky', false)

	makeLuaSprite('deathbg', 'deathbg', -1700, -900);
	scaleObject('deathbg', 2, 2);
	setProperty('deathbg.visible', false)
	addLuaSprite('deathbg', false)

	makeLuaSprite('deathsky', 'yeah', -1700, -1350);
	scaleObject('deathsky', 2, 3);
