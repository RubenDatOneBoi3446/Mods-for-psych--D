...
function onCreate()
	...
	if dadName == 'bandu-origin' then
		makeAnimatedLuaSprite('animatedicon', 'icons/bandu_origin_icon', getProperty('iconP2.x'), getProperty('iconP2.y'))
		addAnimationByPrefix('animatedicon', 'normal', 'bandu-origin', 24, true)
		addAnimationByPrefix('animatedicon', 'losing', 'bandu-origin', 24, true)
