...
function onCreate()
	...
	if dadName == 'dave-unchecked' then
		makeAnimatedLuaSprite('animatedicon', 'icons/unchecked_icon', getProperty('iconP2.x'), getProperty('iconP2.y'))
		addAnimationByPrefix('animatedicon', 'normal', 'dave-unchecked', 24, true)
		addAnimationByPrefix('animatedicon', 'losing', 'dave-unchecked', 24, true)
		setScrollFactor('animatedicon', 0, 0)
		setObjectCamera('animatedicon', 'other')
		setProperty('animatedicon.offset.x', -10)
